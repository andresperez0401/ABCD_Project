...
const ModalIdioma = ({ isEditing, formData, handleInputChange, handleSubmit, onClose }) => {
    ...
    <div className="admin-modal-overlay" tabIndex={-1} onClick={e => {
      ...
      <div className="admin-modal-content" ref={modalRef} onClick={e => e.stopPropagation()} role="dialog" aria-modal="true">
        <div className="admin-modal-header">
          <h2>{isEditing ? "Editar Idioma" : "Nuevo Idioma"}</h2>
        ...
        <form onSubmit={handleFormSubmit} className="admin-modal-form">
          <div className="admin-form-group">
            ...
            <input id="nombre" name="nombre" value={formData.nombre} onChange={handleInputChange} required placeholder="Ej: Inglés" />
          </div>
          <div className="admin-form-group">
            <label htmlFor="descripcion">Descripción:</label>
            <input id="descripcion" name="descripcion" value={formData.descripcion} onChange={handleInputChange} required placeholder="Ej: Idioma global..." />
          </div>
          <div className="admin-form-section">
            <h3>Imagen del Idioma</h3>
            <div className="admin-image-uploader">
              <input
                ...
                id="idioma-image"
              />
              <label htmlFor="idioma-image" className="admin-upload-btn">
            ...
            <button type="submit" className="admin-btn-save" disabled={uploading}>
              {uploading ? (
                ...
                <>
                  ...
                  <span>{isEditing ? "Actualizar" : "Crear Idioma"}</span>
                </>
              )}
            </button>
